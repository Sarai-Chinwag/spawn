...
class Abilities {
	...
	public static function register_abilities(): void {
		...
		// Check Environment
		wp_register_ability( 'spawn/self-check-environment', array(
			...
			'category'            => 'spawn',
			'execute_callback'    => array( Ability_Self_Spawn::class, 'check_environment' ),
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(),
			),
			'output_schema'       => array(
				...
				'properties' => array(
					...
					'can_install'     => array( 'type' => 'boolean' ),
					'blockers'        => array( 'type' => 'array' ),
					'credentials_url' => array( 'type' => 'string' ),
				),
			),
			'permission_callback' => array( __CLASS__, 'check_admin_permission' ),
		) );
		...
		wp_register_ability( 'spawn/self-get-status', array(
			'label'               => __( 'Get OpenClaw Status', 'spawn' ),
			'description'         => __( 'Get status of locally installed OpenClaw', 'spawn' ),
			'category'            => 'spawn',
			'execute_callback'    => array( Ability_Self_Spawn::class, 'get_status' ),
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(),
			),
			'output_schema'       => array(
				...
				'properties' => array(
					...
					'config_exists' => array( 'type' => 'boolean' ),
				),
			),
			'permission_callback' => array( __CLASS__, 'check_admin_permission' ),
		) );
		...
		// Start OpenClaw
		wp_register_ability( 'spawn/self-start', array(
			'label'               => __( 'Start OpenClaw', 'spawn' ),
			'description'         => __( 'Start the OpenClaw gateway service', 'spawn' ),
			'category'            => 'spawn',
			'execute_callback'    => array( Ability_Self_Spawn::class, 'start' ),
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(),
			),
		...
		// Stop OpenClaw
		wp_register_ability( 'spawn/self-stop', array(
			'label'               => __( 'Stop OpenClaw', 'spawn' ),
			'description'         => __( 'Stop the OpenClaw gateway service', 'spawn' ),
			'category'            => 'spawn',
			'execute_callback'    => array( Ability_Self_Spawn::class, 'stop' ),
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(),
			),
		...
		// Restart OpenClaw
		wp_register_ability( 'spawn/self-restart', array(
			'label'               => __( 'Restart OpenClaw', 'spawn' ),
			'description'         => __( 'Restart the OpenClaw gateway service', 'spawn' ),
			'category'            => 'spawn',
			'execute_callback'    => array( Ability_Self_Spawn::class, 'restart' ),
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(),
			),
		...
		// Uninstall OpenClaw
		wp_register_ability( 'spawn/self-uninstall', array(
			'label'               => __( 'Uninstall OpenClaw', 'spawn' ),
			'description'         => __( 'Remove OpenClaw from this server', 'spawn' ),
			'category'            => 'spawn',
			'execute_callback'    => array( Ability_Self_Spawn::class, 'uninstall' ),
			'input_schema'        => array(
				'type'       => 'object',
				'properties' => array(
					'confirm' => array(
